    ...
    <Card>
      <div className={[styles.publish,'mx560'].join(' ')}>
        ...
        >
          ...
          <ProFormText name="status" label="状态" readonly={true}/>
          <ProFormText name="publish-er" label="发布人" readonly={true}/>
          <ProFormText name="publish-time" label="发布时间" readonly={true}/>
