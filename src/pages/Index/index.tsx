      ...
      <div className={styles.leftTop}>
        <div className={styles.leftTop1}>
          <Card title={
            ...
            <Statistic title="待筛选人才" value={112893} valueStyle={{marginTop:'30px'}}/>
          </Card>
        </div>
        <div className={styles.leftTop2}>
          <Card title={<span><MyIcon type='icon-icon_wodezhiwei'/><span className='card_title'>我的职位</span></span>}
                bordered={false}
                extra={<Button type={"primary"}>发布职位</Button>}
                bodyStyle={{padding:'36px 36px 36px 48px'}}
                style={{width: '100%', height: '100%'}}>
            <Row gutter={16}>
              <Col span={12}>
                <Statistic title="在线职位" value={112893} valueStyle={{marginTop:'30px'}}/>
              </Col>
              <Col span={12}>
                <Statistic title="7天内即将下线" value={1} valueStyle={{marginTop:'30px'}}/>
              </Col>
            </Row>
          </Card>
        </div>
    ...
    <Col className={styles.gutterRow} span={8}>
      <div className={styles.rightTop}>
        <Card
          ...
          <Row align="bottom">
            <Col span={18}>
              <Statistic title="在线职位" value={112893} valueStyle={{marginTop:'35px'}}/>
            </Col>
            <Col span={6}><Button type={"primary"} style={{marginBottom:'3px'}}>充值</Button></Col>
          </Row>
          <Divider />
          <Row align="bottom">
            <Col span={18}>
              <Statistic title="课程售卖收入" value={112893} valueStyle={{marginTop:'35px'}}/>
            </Col>
            <Col span={6}><Button style={{marginBottom:'3px'}}>提现</Button></Col>
          </Row>
        </Card>
      </div>
      <div className={styles.rightBottom}>
        <Card title={<span><MyIcon type='icon-icon_wodequanyi'/><span className='card_title'>我的权益</span></span>}
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Statistic title="剩余发布职位数" value={112893} valueStyle={{marginTop:'18px'}}/>
            </Col>
            <Col span={12}>
              <Statistic title="剩余职位刷新数" value={1} valueStyle={{marginTop:'18px'}}/>
            </Col>
          </Row>
          <Divider />
          <Row gutter={16}>
            <Col span={12}>
              <Statistic title="剩余查看简历数" value={112893} valueStyle={{marginTop:'20px'}}/>
            </Col>
            <Col span={12}>
              <Statistic title="剩余人才沟通数" value={1} valueStyle={{marginTop:'20px'}}/>
            </Col>
          </Row>
          <Divider />
          <Row gutter={16}>
            <Col span={12}>
              <Statistic title="剩余职位制定数" value={112893} valueStyle={{marginTop:'20px'}}/>
            </Col>
          </Row>
        </Card>
      </div>
